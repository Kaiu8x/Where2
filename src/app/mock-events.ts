...
export const EVENTS: Event[] = [
  ...
  },
  {
    ...
    thread: [],
    image:
      "https://www.gannett-cdn.com/-mm-/d7ac9b920d336ef76c58a5b3a3afb042000218bd/c=0-26-580-461/local/-/media/2018/01/24/USATODAY/usatsports/buffalo-wild-wings-bwld-chicken-soda-beer-sports-source-bwld_large.jpg?width=540&height=405&fit=crop"
  },
  {
    eventId: 5,
